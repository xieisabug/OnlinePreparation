...
<body>
    ...
    <div class="left">
        <div id="parts">
            ...
            <div class="ui icon middle button" onclick="addPart()"><i class="add icon"></i></div>
            <div class="ui icon middle button" onclick="playSlide()"><i class="play circle icon"></i></div>
        </div>
        <div id="editor">
